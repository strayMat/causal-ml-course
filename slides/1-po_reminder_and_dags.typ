...
#slide(title: "Causal inference: subfield of statistics dealing with \"why questions\"")[
  ...
  #grid(
    columns: (auto, auto),
    gutter: 3pt,
    image("img/1-po_reminder_and_dags/what_if.jpg", width: 40%),
    image("img/1-po_reminder_and_dags/causal_ml_book.png", width: 47%),
  )
...
#slide(title: "This is different from predictive questions")[
  ...
  #uncover((6, 7))[
    #side-by-side(gutter: 3mm, columns: (1fr, 1fr))[
      #figure(image("img/1-po_reminder_and_dags/dag_x_to_y.svg", width: 40%))
    ][
...
#slide(title: "Machine learning is pattern matching")[
  ...
  #figure(
    image("img/1-po_reminder_and_dags/ml_curve_fitting.png", width: 55%),
...
#slide(title: "Machine learning is pattern matching that generalizes to new data")[
  ...
  #figure(
    image("img/1-po_reminder_and_dags/cross_validation.png", width: 50%),
...
#slide(title: "Machine learning is great for prediction on complex data")[
  ...
  #side-by-side(
    ...
    [
      ...
      #only(1)[
        #figure(
          image("img/1-po_reminder_and_dags/image_classification.png", width: 100%),
          caption: "ImageNet 1K: 1.5 million images, 1000 classes",
        )
      ]
      #only(3)[
        #figure(
          image("img/1-po_reminder_and_dags/ner_edsnlp.png", width: 100%),
...
#slide(title: [Illustration: observational data])[
  ...
  #figure(
    image("img/1-po_reminder_and_dags/sample_wo_oracles_gray.png", width: 83%),
...
#slide(title: [Illustration: observational data])[
  ...
  #figure(
    image("img/1-po_reminder_and_dags/sample.svg", width: 75%),
    //caption: "DAG for a RCT: the treatment is independent of the confounders",
  )
]
...
#slide(title: [Illustration: observational data, a naive solution])[
  ...
  #uncover(2)[
    #figure(
      image("img/1-po_reminder_and_dags/sample_mean_difference.png", width: 75%),
      //caption: "DAG for a RCT: the treatment is independent of the confounders",
    )
  ]
]
...
#slide(title: [Illustration: RCT data])[
  #figure(
    image("img/1-po_reminder_and_dags/sample_rct.svg", width: 83%),
    //caption: "DAG for a RCT: the treatment is independent of the confounders",
  )
]
...
#slide(title: [Illustration: RCT data, a naive solution #only(2)[that works!]])[
  ...
  #figure(image("img/1-po_reminder_and_dags/sample_rct_mean_difference.png", width: 75%))
]

#slide(title: "Four steps of causal inference")[
  #set align(center)
  #image("img/1-po_reminder_and_dags/complete_inference_flow.png", width: 95%)
...
#slide(title: [Potential outcomes, @neyman1923applications @rubin1974estimating])[
  ...
  #uncover(2)[
    #figure(image("img/1-po_reminder_and_dags/sample_po.png", width: 60%))
  ]
]
...
#slide(title: "Causal estimand: What is the targeted quantity (with potential outcomes)?")[
  ...
  #uncover(2)[
    #figure(image("img/1-po_reminder_and_dags/po_sample_estimand.png", width: 80%))
  ]
]
...
#slide(title: "Assumption 2: Overlap, also known as positivity")[
  ...
  #figure(image("img/1-po_reminder_and_dags/overlap.png", width: 60%))
...
#slide(title: "Famous examples of confounders")[
  ...
  #figure(image("img/1-po_reminder_and_dags/confounder.svg", width: 20%))
...
#slide(title: "Famous examples of instrumental variables")[
  ...
  #figure(image("img/1-po_reminder_and_dags/instrumental_variable.svg", width: 20%))
...
#slide(title: "Famous examples of colliders")[
  ...
  #figure(
    image("img/1-po_reminder_and_dags/collider_pre_outcome.excalidraw.svg", width: 20%),
...
#slide(title: "Which variable to include into your analysis?")[
  ...
  #grid(
    ...
    gutter: 1pt,
    figure(
      image("img/1-po_reminder_and_dags/confounder.svg", width: 40%),
      caption: [Confounder ✅],
    ),
    figure(
      image("img/1-po_reminder_and_dags/instrumental_variable.svg", width: 40%),
      caption: [Instrumental variable ❌ #linebreak() (generally)],
    ),
    figure(
      image("img/1-po_reminder_and_dags/dag_x_to_y.svg", width: 40%),
      caption: [Outcome parent ✅ #linebreak() (generally)],
    ),
    figure(
      image("img/1-po_reminder_and_dags/collider.svg", width: 40%),
      caption: [Collider ❌],
    ),
  )
  ...
  #grid(
    ...
    gutter: 1pt,
    figure(
      image("img/1-po_reminder_and_dags/mediator.svg", width: 40%),
    caption: [Mediator #uncover(2)[❌ (generally)]],
    ),
    figure(
      image("img/1-po_reminder_and_dags/effect_modifier.svg", width: 40%),
...
#slide(title: "DAG: Effect modifier")[
  ...
  #figure(image("img/1-po_reminder_and_dags/effect_modifier.svg", width: 20%))
