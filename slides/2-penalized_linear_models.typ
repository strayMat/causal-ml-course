...
#slide(title: "Statistical learning, two classes of problems")[
  ...
  #side-by-side[
    #figure(image("img/2-penalized_linear_models/linear_regression.png", width: 80%))
  ][
    === Regression
...
#slide(title: "Statistical learning, two classes of problems")[
  #side-by-side[
    #figure(image("img/2-penalized_linear_models/linear_classification.png", width: 80%))
  ][
    === Classification
...
#slide(title: "Under vs. overfitting")[
  ...
  #grid(
    columns: (auto, auto),
    gutter: 3pt,
    image("img/2-penalized_linear_models/linear_ols.svg", width: 70%),
    image("img/2-penalized_linear_models/linear_splines.svg", width: 70%),
  )
]
...
#slide(title: "Under vs. overfitting")[
  ...
  #grid(
    columns: (auto, auto),
    gutter: 3pt,
    image("img/2-penalized_linear_models/linear_ols_test.svg", width: 70%),
    image("img/2-penalized_linear_models/linear_splines_test.svg", width: 70%),
  )
...
#slide(title: "How to choose the complexity of the model?")[
  #grid(
    columns: (auto, auto),
    gutter: 3pt,
    image("img/2-penalized_linear_models/ols_simple_test.svg", width: 70%),
    image("img/2-penalized_linear_models/splines_cubic_test.svg", width: 70%),
  )
...
#slide(title: "Empirical risk minimization: estimation error illustration")[
  ...
  #grid(
    ...
    gutter: 3pt,
    align: center,
    image("img/2-penalized_linear_models/polynomial_overfit_simple_legend.svg", width: 90%),
    [
      #set align(left)
...
#slide(title: "Empirical risk minimization: approximation error illustration")[
  ...
  #grid(
    ...
    gutter: 3pt,
    align: center,
    image("img/2-penalized_linear_models/polynomial_underfit_simple.svg", width: 90%),
    [
      #set align(left)
...
#slide(title: "Train vs test error: increasing complexity")[
  ...
  #only(1)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_test_1.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_validation_curve_1.svg", width: 80%),
    )
  ]
  #only(2)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_test_2.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_validation_curve_2.svg", width: 80%),
    )
  ]
  #only(3)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_test_5.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_validation_curve_5.svg", width: 80%),
    )
  ]
  #only(4)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_test_9.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_validation_curve_15.svg", width: 80%),
    )
  ]

  #only(5)[
    #figure(image("img/2-penalized_linear_models/polynomial_validation_curve_15.svg", width: 50%))
    #set text(size: 1.3em)
    #align(left)[
      #h(6em)
...
#slide(title: "Varying sample size")[
  ...
  #only(1)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_ntrain_42.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_learning_curve_42.svg", width: 80%),
    )
    #align(left)[
      #h(3em)
  ...
  #only(2)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_ntrain_145.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_learning_curve_145.svg", width: 80%),
    )
  ]

  #only(3)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_ntrain_1179.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_learning_curve_1179.svg", width: 80%),
    )
    #align(left)[
      #h(3em)
  ...
  #only(4)[
    #side-by-side(
      image("img/2-penalized_linear_models/polynomial_overfit_ntrain_6766.svg", width: 80%),
      image("img/2-penalized_linear_models/polynomial_learning_curve_6766.svg", width: 80%),
    )
    #align(left)[
      #h(3em)
  ...
  #only(5)[
    #side-by-side(
      columns: (1fr, 1.7fr),
      image("img/2-penalized_linear_models/polynomial_overfit_ntrain_6766.svg", width: 100%),
      [
...
#slide(title: "Reminder: Linear regression")[
  ...
  #only(2)[
    #figure(image("img/2-penalized_linear_models/linear_fit_red.svg", width: 50%))
  ]
...
#slide(title: "Linear regression: Illustration in two dimensions")[
  #figure(image("img/2-penalized_linear_models/lin_reg_3D.svg", width: 50%))
]
...
#slide(title: "Reminder: classification, logistic regression")[
  #side-by-side(
    ...
    [
      #image("img/2-penalized_linear_models/Precisionrecall.svg.png", width: 80%)
    ],
  )
...
#slide(title: "Logistic regression: Illustrations")[
  ...
  #side-by-side(
    [
      #image("img/2-penalized_linear_models/logistic_color.svg", width: 80%)
      Logistic regression in one dimension.
    ],
    [
      #image("img/2-penalized_linear_models/logistic_2D.svg", width: 80%)
...
#slide(title: "Linear models are not suited to all data")[
  ...
  #side-by-side(
    [
      #image("img/2-penalized_linear_models/lin_separable.svg", width: 80%)
      Almost linearly separable data.
    ],

    [
      #image("img/2-penalized_linear_models/lin_not_separable.svg", width: 80%)
...
#slide(title: "How to choose lambda?")[
  ...
  #uncover((3, 4))[
    ...
    #figure(image("img/2-penalized_linear_models/cross_validation_diagram.png", width: 50%))
  ]
  #uncover(4)[
